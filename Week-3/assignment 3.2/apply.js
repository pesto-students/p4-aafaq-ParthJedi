...
let max = Math.max.apply(null, numbers); // null here signifies that no explicit context value was provided for binding and it internally passes the array items as positional arguments.
